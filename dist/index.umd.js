(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('antd'), require('react'), require('react-dom')) :
	typeof define === 'function' && define.amd ? define(['exports', 'antd', 'react', 'react-dom'], factory) :
	(global = global || self, factory(global.testLibrary = {}, global.antd, global.React, global.ReactDOM));
}(this, function (exports, antd, React, ReactDOM) { 'use strict';
	...
	var _stylisRuleSheet_0_0_10_stylisRuleSheet = createCommonjsModule(function (module, exports) {
	(function (factory) {
	...
	var _reactIs_16_7_0_reactIs = createCommonjsModule(function (module) {
	...
	var _reactIs_16_7_0_reactIs_1 = _reactIs_16_7_0_reactIs.ForwardRef;
	var _reactIs_16_7_0_reactIs_2 = _reactIs_16_7_0_reactIs.isElement;
	var _reactIs_16_7_0_reactIs_3 = _reactIs_16_7_0_reactIs.isValidElementType;
	...
	*/
	...
	var parseRulesPlugin = _stylisRuleSheet_0_0_10_stylisRuleSheet(function (rule) {
	  ...
	  if (isFunction(chunk)) {
	    if (executionContext) {
	      ...
	      try {
	        ...
	        if (_reactIs_16_7_0_reactIs_2(new chunk(executionContext))) {
	          shouldThrow = true;
	        }
	      } catch (e) {
	        /* */
	...
	function constructWithOptions(componentConstructor, tag) {
	  ...
	  if (!_reactIs_16_7_0_reactIs_3(tag)) {
	...
	var TYPE_STATICS = (_TYPE_STATICS = {}, _TYPE_STATICS[_reactIs_16_7_0_reactIs_1] = {
	  $$typeof: true,
	  render: true
	}, _TYPE_STATICS);
	...
	process.env.NODE_ENV !== "production" ? StyleSheetManager.propTypes = {
	  sheet: _propTypes_15_6_2_propTypes.oneOfType([_propTypes_15_6_2_propTypes.instanceOf(StyleSheet), _propTypes_15_6_2_propTypes.instanceOf(ServerStyleSheet)]),

	  target: _propTypes_15_6_2_propTypes.shape({
	    appendChild: _propTypes_15_6_2_propTypes.func.isRequired
	  })
	} : void 0;
	...
	daaa(111111);
	const AlertV = styled(antd.Alert)`
  &.ant-alert {
    line-height: 1.2;
    margin-bottom: 16px;
  }
...
`;
	const propTypes = {
	  id: _propTypes_15_6_2_propTypes.string,

	  /** 类型 */
	  type: _propTypes_15_6_2_propTypes.string.isRequired,

	  /** 消息 */
	  message: _propTypes_15_6_2_propTypes.string.isRequired
	};
	...
	const AcpAlert = props => {
	  ...
	  return React__default.createElement(AlertV, _extends_1({}, p, {
	    onClose: () => close()
	  }));
	};
	...
	*/
	...
	const avatarSizeToClassName = size => _classnames_2_2_6_classnames(styles.avatarItem, {
	...
	const AvatarList = (_ref) => {
	  let {
	    ...
	    excessItemsStyle
	      ...
	      other = objectWithoutProperties$1(_ref, ["children", "size", "maxLength", "excessItemsStyle"]);

	  const numOfChildren = React__default.Children.count(children);
	  const numToShow = maxLength >= numOfChildren ? numOfChildren : maxLength;
	  const childrenWithProps = React__default.Children.toArray(children).slice(0, numToShow).map(child => React__default.cloneElement(child, {
	    size
	  }));

	  if (numToShow < numOfChildren) {
	    const cls = avatarSizeToClassName(size);
	    childrenWithProps.push(React__default.createElement("li", {
	      key: "exceed",
	      className: cls
	  ...
	  return React__default.createElement("div", _extends_1({}, other, {
	    className: styles.avatarList
	  }), React__default.createElement("ul", null, " ", childrenWithProps, " "));
	};
	...
	const Item = ({
	  ...
	  return React__default.createElement("li", {
	    className: cls,
	    onClick: onClick
	  }, tips ? React__default.createElement(antd.Tooltip, {
	    title: tips
	  }, React__default.createElement(antd.Avatar, {
	    src: src,
	    size: size,
	...
	class CountDown extends React.Component {
	  constructor(props) {
	    ...
	    this.defaultFormat = time => {
	      ...
	      return React__default.createElement("span", null, fixedZero(h), ":", fixedZero(m), ":", fixedZero(s));
	    };
	  ...
	  render() {
	    const _this$props = this.props,
	      ...
	      onEnd
	          ...
	          rest = objectWithoutProperties$1(_this$props, ["format", "onEnd"]);

	    const {
	      lastTime
	    } = this.state;
	    const result = format(lastTime);
	    return React__default.createElement("span", rest, result);
	  }
